...
export function createSpace(req: CreateSpaceReq) {
  return request.post('/wiki/spaces', req)
}

export function listSpaces(params?: { page?: number; page_size?: number }) {
  return request.get('/wiki/spaces', { params })
}

export function getSpace(id: string) {
  return request.get(`/wiki/spaces/${id}`)
}

export function updateSpace(id: string, req: UpdateSpaceReq) {
  return request.put(`/wiki/spaces/${id}`, req)
}

export function deleteSpace(id: string) {
  return request.delete(`/wiki/spaces/${id}`)
}

export function getNodeTree(spaceId: string) {
  return request.get(`/wiki/spaces/${spaceId}/nodes/tree`)
}

export function createNode(spaceId: string, req: CreateNodeReq) {
  return request.post(`/wiki/spaces/${spaceId}/nodes`, req)
}

export function getNode(id: string) {
  return request.get(`/wiki/nodes/${id}`)
}

export function updateNode(id: string, req: UpdateNodeReq) {
  return request.put(`/wiki/nodes/${id}`, req)
}

export function deleteNode(id: string) {
  return request.delete(`/wiki/nodes/${id}`)
}

export function createDocument(nodeId: string, req: CreateDocumentReq) {
  return request.post(`/wiki/documents/nodes/${nodeId}`, req)
}

export function getDocument(nodeId: string) {
  return request.get(`/wiki/documents/nodes/${nodeId}`)
}

export function updateDocument(id: string, req: UpdateDocumentReq) {
  return request.put(`/wiki/documents/${id}`, req)
}

export function deleteDocument(id: string) {
  return request.delete(`/wiki/documents/${id}`)
}

export function listRevisions(documentId: string) {
  return request.get(`/wiki/documents/${documentId}/revisions`)
}

export function getRevision(documentId: string, version: number) {
  return request.get(`/wiki/documents/${documentId}/revisions/${version}`)
}

export function restoreRevision(documentId: string, version: number) {
  return request.post(`/wiki/documents/${documentId}/revisions/${version}/restore`)
}

export function listMembers(spaceId: string) {
  return request.get(`/wiki/spaces/${spaceId}/members`)
}

export function addMember(spaceId: string, req: AddMemberReq) {
  return request.post(`/wiki/spaces/${spaceId}/members`, req)
}

export function removeMember(spaceId: string, userId: string) {
  return request.delete(`/wiki/spaces/${spaceId}/members/${userId}`)
}

export function getWikiStats() {
  return request.get('/wiki/stats')
}